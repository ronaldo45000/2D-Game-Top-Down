class Skeleton {
  ...
  updateBB() {
    ...
    this.BB = new BoundingBox(this.x -20- this.game.camera.x, this.y -20- this.game.camera.y, 60,60);
...
// //      ctx.restore();
      ...
      if (PARAMS.DEBUG) {
        ...
        ctx.strokeRect(this.x -20- this.game.camera.x, this.y -20- this.game.camera.y, 60,60);
